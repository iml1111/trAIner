...
class TrainerDatasetV3(Dataset):
    ...
    def __init__(self, data_path):
        ...
        self.y = np.expand_dims(self.y, axis=1)
        self.user_item_cnts = np.max(self.x, axis=0) + 1
        self.user_cnt, self.item_cnt = self.user_item_cnts
...
if __name__ == '__main__':
    data_path = "/mnt/c/Users/IML/Desktop/data/sparse_matrix_v3.csv"
    dataset = TrainerDatasetV3(data_path)
    print(dataset[0])